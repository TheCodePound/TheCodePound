...
select users.full_name, users.profile_pic, posts.title, posts.content, posts.post_id, posts.user_id, img.img, languages.languages, languages.languages_img from posts
